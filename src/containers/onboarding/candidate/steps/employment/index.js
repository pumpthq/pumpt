...
import EmploymentForm from './content'
import OnboardingCandidateLinker from './../linker'

class EmploymentStep extends Component {
    componentDidMount() {
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 column__wrapper'>
                        <section class='column column_size_l'>
                            <Panel paddingBig >
                                ...
                                <span class='onboarding-header col-lg-10 col-md-10 col-sm-10 col-xs-10'>What is your preferred employment type?</span>
