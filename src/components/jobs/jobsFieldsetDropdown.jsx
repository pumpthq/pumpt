...
class JobsFieldsetDropdown extends Component {
    ...
    forEachList(array) {
        ...
        return array.map((element) => {
            ...
            return (
                <li
                    className={`list__item ${element.items ? 'list__item_sub_true' : ''}`}
                    onClick={() => {
                        if (!element.items) {
                ...
                >
                    <span
                        className={'dropdown__link' + (isChecked ? ' dropdown__link_active' : '')}
                    >
                        {element.title}
...
JobsFieldsetDropdown.propTypes = {
...
JobsFieldsetDropdown.defaultProps = {
    value: '',
    label: '',
    type: 'text',
    error: false,
