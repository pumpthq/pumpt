...
const updateJob = ({ id, accessToken, body }) => {
    return axios({
        method: 'PUT',
        baseURL: API_URL,
...
const removeJob = ({ id, accessToken }) => {
    return axios({
        method: 'DELETE',
        baseURL: API_URL,
        url: `${API_VACANCY_ROOT}/${id}`,
...
const getDraftsJobs = ({ accessToken }) => {
    return axios({
        method: 'GET',
        baseURL: API_URL,
        url: API_DRAFT_JOBS,
...
const getClosedJobs = ({ accessToken }) => {
    return axios({
        method: 'GET',
        baseURL: API_URL,
        url: API_CLOSED_JOBS,
...
const createJob = ({ accessToken, body }) => {
    return axios({
        method: 'POST',
        baseURL: API_URL,
